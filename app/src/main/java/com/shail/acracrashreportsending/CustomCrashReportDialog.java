...
public class CustomCrashReportDialog extends BaseCrashReportDialog implements DialogInterface.OnClickListener {
    ...
    protected void init(@Nullable Bundle savedInstanceState) {
        ...
        buildAndShowDialogV1(savedInstanceState);
    }
     ...
     */
    protected void buildAndShowDialogV1(@Nullable Bundle savedInstanceState) {
        ...
        dialogBuilder.setMessage(R.string.crash_report_dialog_message);
     ...
     * @param savedInstanceState old state to restore
     */
    protected void buildAndShowDialogV2(@Nullable Bundle savedInstanceState) {
        final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(this);
        final int titleResourceId = getConfig().resDialogTitle();
        if (titleResourceId != ACRAConstants.DEFAULT_RES_VALUE) {
            dialogBuilder.setTitle(titleResourceId);
